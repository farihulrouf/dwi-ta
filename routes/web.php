...
Route::get("/menuprice/{fields}/{id}","ItemController@menuprice");
Route::get("addcart/{item_id}","Cartcontroller@addcart");
Route::get("detailitem/{id}/{size}","frontController@detailitem");
Route::get("getitemdetails/{id}/{fields}","frontController@getitemdetails");
Route::get("itemchanges","frontController@itemchanges");
...
Route::group(['middleware' => ['admincheckexiste']], function () {
    ...
    Route::any("saveaboutus","AuthenticationController@saveaboutus");
    Route::any("saveconatct","AuthenticationController@saveconatct");
	//menu category
