...
Route::any("login","api\ApiController@showlogin");//register
...
Route::get("getsetting/{key}","api\ApiController@getsetting");
Route::get("bookorder","api\ApiController@bookorder");
