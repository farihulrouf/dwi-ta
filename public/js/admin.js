...
function editmenu(id){
    $.ajax( {
         ...
         success: function( data ) {
           ...
           $('#small_price').val(data.small_price);
           $('#medium_price').val(data.medium_price);
           $('#large_price').val(data.large_price);
...
function yesnoCheck(val,data) {
    if ((document.getElementById('yesCheck').checked||document.getElementById("edittype").checked)&&($("#edittype").val()==data||$("#yesCheck").val()==data)) {
            document.getElementById("small_price_"+val+"_1").style.display="block";
            document.getElementById("medium_price_"+val+"_1").style.display="block";
            document.getElementById("large_price_"+val+"_1").style.display="block";
            document.getElementById("small_price_"+val).required=true;
            document.getElementById("medium_price_"+val).required=true;
            document.getElementById("large_price_"+val).required=true;
    }
    else 
    {     
            document.getElementById("small_price_"+val+"_1").style.display="none";
            document.getElementById("medium_price_"+val+"_1").style.display="none";
            document.getElementById("large_price_"+val+"_1").style.display="none";
            document.getElementById("small_price_"+val).required=false;
            document.getElementById("medium_price_"+val).required=false;
            document.getElementById("large_price_"+val).required=false;
    }   
}
   ...
   function savegeneralinfo(){
               ...
               function savesoicallogin(){
                         ...
                         $.ajax( {
                                         ...
                                         success: function( data ) {
                                           // alert($("#datasave").val());
                                              ...
                                              $("#shipping").removeClass('in show active');
                                              $('a[href="#shipping"]').removeClass('active');
                                              $('a[href="#aboutus"]').addClass('active');
                                              $("#aboutus").addClass('in show active');
                ...
                function changeaboutus(){
                    var aboutus=CKEDITOR.instances['aboutustxt'].getData();
                    if(aboutus!=""){
                             $.ajax( {
                                         url: $("#path_admin").val()+"/saveaboutus",
                                         method:"get",
                                         data: { 
                                            aboutus:aboutus
                                         },
                                         success: function( data ) {
                                              $("#aboutus").removeClass('in show active');
                                              $('a[href="#aboutus"]').removeClass('active');
                                              $('a[href="#contact"]').addClass('active');
                                              $("#contact").addClass('in show active');
                ...
                function changecontact(){
                    var contact=CKEDITOR.instances['conatcttxt'].getData();
                    if(contact!=""){
                             $.ajax( {
                                         url: $("#path_admin").val()+"/saveconatct",
                                         method:"get",
                                         data: { 
                                            contact:contact
                                         },
                ...
                for(var i=0;i<data.itemdata.length;i++){
                     ...
                     txt=txt+'</td><td>'+str.toUpperCase()+'</td><td>'+data.itemdata[i].item_qty+'</td>';
                             if(str.toUpperCase()=="M"){
                                 ...
                                 txt=txt+'<td>'+data.itemdata[i].itemdata.large_price+" "+data.currency+'</br>';
                            } 
