...
static public function generate_timezone_list(){
   ...
   public function orderaction($id,$status){
      ...
      if($status==1){//accept
          ...
          $order->save();
           event(new FormSubmitted(__('messages.site_name'),$msg,$order->user_id,asset('burger/images/web-nav-logo.png')));
   ...
   public function waitingforpickup($id){
    ...
    public function getorderinfo($id){
      ...
      foreach ($itemdata as $k) {        
       ...
       $order->delivery_charges=number_format($order->delivery_charges,2,'.','');
     ...
     if($getorder){
      ...
      date_default_timezone_set($gettimezone);
           ...
           $msg=__('successerr.order_assign_success');
            ...
            event(new FormSubmitted(__('messages.site_name'),$msg,$getorder->user_id,asset('burger/images/web-nav-logo.png')));
