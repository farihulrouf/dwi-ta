               ...
               <form name="menu_form_category" action="{{url('add_menu_item')}}" method="post" enctype="multipart/form-data">
                ...
                <!--   <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" placeholder="{{__('messages.Small Price')}}" name="small_price"  required>
                  </div>
                    <div class="form-group">
                     <label>{{__('messages.Medium Price')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.Medium Price')}}" name="medium_price"  required>
                  </div>
                    <div class="form-group">
                     <label>{{__('messages.Large Price')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.Large Price')}}" name="large_price"  required>
                  </div>
                  <div class="form-group">
            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('update_menu_item')}}" method="post" enctype="multipart/form-data">
                 ...
                 <!--  <div class="form-group">
                   ...
                   <div class="form-group">
                     <label>{{__('messages.Small Price')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.Small Price')}}" name="small_price"  required id="small_price">
                  </div>
                    <div class="form-group">
                     <label>{{__('messages.Medium Price')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.Medium Price')}}" name="medium_price"  required id="medium_price">
                  </div>
                    <div class="form-group">
                     <label>{{__('messages.Large Price')}}</label>
                     <input type="text" class="form-control" placeholder="{{__('messages.Large Price')}}" name="large_price"  required id="large_price">
                  </div>
                  <div class="form-group">
                     <label>{{__('messages.image')}}</label>
