            ...
            <div class="modal-body">
               <form name="menu_form_category" action="{{url('add_menu_ingre')}}" method="post" enctype="multipart/form-data">
                 ...
                 <!--  <div class="form-group">
                    ...
                    <div class="form-group is_hide" id="small_price_add_1">
                     <label>{{__('messages.Small Price')}}</label>
                     <input type="text" class="form-control" id="small_price_add" placeholder="{{__('messages.Small Price')}}" name="small_price">
                  </div>
                    <div class="form-group is_hide" id="medium_price_add_1">
                     <label>{{__('messages.Medium Price')}}</label>
                     <input type="text" class="form-control" id="medium_price_add" placeholder="{{__('messages.Medium Price')}}" name="medium_price">
                  </div>
                    <div class="form-group is_hide" id="large_price_add_1">
                     <label>{{__('messages.Large Price')}}</label>
                     <input type="text" class="form-control" id="large_price_add" placeholder="{{__('messages.Large Price')}}" name="large_price">
                  </div>
                  <div class="form-group">
