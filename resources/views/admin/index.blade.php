...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      @if(Session::get("is_rtl")=='0')
         ...
         @else
          <link rel="stylesheet" href="{{asset('admin_panel/assets/css/rtl.css')}}">
         @endif
  ...
  <script type="text/javascript">
    ...
    channel.bind('admin-channel', function(data) {
       
        const notification = new Notification({
          effect: 'easex',
          duration: 5000
       });
        if(data.reciver_id=='01'){
          $("#notificationimg").attr("src",data.image);
          notification.success({
              title: data.title, 
              message: data.messages
          });
          console.log("admin notifi");
        }
    });
      </script>
   </head>
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg"></p>
      ...
      <div class="notification">
        <section class="logo">
            <div id="face" >
                <img id="notificationimg" src="{{asset('public/upload/profile/profile.png')}}">
            </div>
        </section>
        <section class="body">
