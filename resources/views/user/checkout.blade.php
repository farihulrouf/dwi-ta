                  ...
                  <div class="card m-b-0">
                     ...
                     <div class="collapse {{$showsec}} " id="collapseTwoH">
                        <div class="card-body">
                           <div class="row">
                              <div class="col-md-6 billing">
                                 ...
                                 <form>
                                    ...
                                    <div class="city phone" id="cityorder" >
                              ...
                              <div class="col-md-6 additional phone">
                           ...
                           <div class="col-md-12 p-0 phone" style="display:<?php echo $display;?>" id="addressorder">
                     ...
                     <div class="collapse {{$showsec}} " id="collapseTH">
                        <div class="cashswipe">
                           <div class="radio check">
                              ...
                              <img id="pay1" onclick="changebutton('Cash')" src="{{asset('design/images/5.png')}}"/>
                           </div>
                           ...
                           <div class="check">
                              ...
                              <img id="pay2" onclick="changebutton('Paypal')" src="{{asset('design/images/1.png')}}"/>
                           </div>
                           @endif
                           ...
                           <div class="check">
                              ...
                              <img id="pay3" onclick="changebutton('Stripe')" src="{{asset('design/images/2.png')}}"/>
                           </div>
                            @endif
                        </div>
                     </div>
                             ...
                             <!-- <input type="checkbox" id="home1" name="shipping_type" class="checkbox-custom" value="0" onclick="changeoption(this.value)" <?php echo ($shipping==0 ? 'checked' : '');?> >
                              ...
                              {{__('messages.HD')}}
                               ...
                               <label class="custom-checkbox-label">
                                     {{__('messages.HD')}}
                                     <input type="checkbox" id="checkbox-0" class="checkbox-custom" name="shipping_type" value="0" onclick="changeoption(this.value)" <?php echo ($shipping==0 ? 'checked' : '');?>>
                        ...
                        <div class="cart-bs-content-2">
                           <form>
                              <p>
                                  <label class="custom-checkbox-label">
                                     {{__('messages.LP')}}
                                     <input type="checkbox" id="checkbox-1" class="checkbox-custom" name="shipping_type" value="1" onclick="changeoption(this.value)" <?php echo ($shipping==1 ? 'checked' : '');?>>
                                    <span class="checkmark"></span>
                                </label>
