         ...
         <ul>
            <li class="process-1">
               <div class="pro-rou">
                  ...
                  <div class="round-d">
                     <img src="{{asset('design/images/ture.png')}}">
                  </div>
               </div>
            </li>
            <?php
            ...
            <li class="{{$class2}}">
               ...
               <div class="pro-rou">
                  <div class="round-{{$divclass2}}">
                     ...
                     <img src="{{asset('design/images/ture.png')}}">
                     <?php }else{?>
                     <span><img src="{{asset('design/images/preparing.png')}}"></span>
                     <?php }?>
                  </div>
               </div>
            </li>
            ...
            <li class="{{$class3}}">
               ...
               <div class="pro-rou">
                  <div class="round-{{$divclass3}}">
                     ...
                     <img src="{{asset('design/images/ture.png')}}">
                     <?php }else{?>
                     <span><img src="{{asset('design/images/address.png'
                     )}}"></span>
                     <?php }?>
                  </div>
               </div>
            ...
            <?php
               ...
               ?>
            <li class="no-process-last">
               <div class="order-d-text">
                    @if($order->shipping_type==1)
                       <h1>{{__('messages.ordered_pickup')}}</h1>
                   @else
               ...
               <div class="pro-rou">
                  <div class="round-{{$divclass4}}">
                     ...
                     <img src="{{asset('design/images/ture.png')}}">
                     <?php }else{?>
                     <span><img src="{{asset('design/images/order.png')}}"></span>
                     <?php }?>
                  </div>
               </div>
            </li>
                     ...
                     <div class="sub-order-1">
                        ...
                        <div class="sub-order-text">
                           <div class="sub-text-1">
                              <h1>{{$item->itemdata->menu_name}}({{ucfirst($item->itemsize)}})</h1>
