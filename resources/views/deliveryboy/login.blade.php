               ...
               <div class="login-form">
                  ...
                  <form action="{{url('deliveryboy/postlogin')}}" method="post">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" class="form-control" value="johndue@gmail.com" placeholder="{{__('messages.email')}}" required name="email" id="email">
                     </div>
                     <div class="form-group">
                        <label>{{__('messages.password')}}</label>
                        <input type="password" name="password" id="password" value="123" class="form-control" placeholder="{{__('messages.password')}}">
                     </div>
